...
### Production examples 
  ...
  - If you are already familiar with WINTR saved requests check our request files to scrape from **Amazon**, **Ebay**, **Zalando** and many more in the [skeletons section](https://github.com/wintrdotcom/wintrAPI/todo)
